...
file_date = '2022-05-18'


# Parse daily HTML into individual JSON stop events
today = date.today()
log_file_path = F"/home/werner/TEST/test_log_files/stop_event_producer_logs-{today.strftime('%Y-%m-%d')}.txt"
json_file_path = F"/home/werner/TEST/test_stop_event_data/json_data/{file_date}.json"

print('Parsing HTML...')

html_file_path = F"/home/werner/TEST/test_stop_event_data/html_data/{file_date}.html"
